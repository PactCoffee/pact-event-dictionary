...
CREATE TABLE IF NOT EXISTS atomic.com_pact_new_recurrable_context_1 (
...
COMMENT ON TABLE atomic.com_pact_new_recurrable_context_1 IS 'iglu:com.pact/new_recurrable_context/jsonschema/1-0-0';
